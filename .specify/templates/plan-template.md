...
**Testing**: Manual testing through simulation runs, unit tests optional  
...
- Plugin Architecture: Feature MUST support shared library interface with getRobot() factory
- Real-time Events: All timing MUST go through Scheduler, no direct component calls
- Hardware Abstraction: Robot interactions MUST use RobCtrl interface only
- Simulation Integrity: Physics MUST remain deterministic and reproducible
- Visual Observability: All game state MUST be visible through SDL2 Viewer
